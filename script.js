...
function criarAbas(departamentos) {
    ...
    const navTabs = document.getElementById('departamentosAbas');  // Correção do método de seleção
                        ...
                        <tbody>
                            ${funcionarios.map(funcionario => `
                                <tr>
                                    ...
                                    <td>${funcionario.Salário}</td> <!-- Corrigido para manter a acentuação consistente -->
                                </tr>
                            `).join('')}
                        </tbody>
                    </table>
    ...
    navTabs.querySelectorAll('.nav-link').forEach(tab => {
        tab.addEventListener('click', (event) => {
            ...
            tabContent.querySelectorAll('.tab-pane').forEach(pane => pane.classList.remove('show', 'active'));  // Correção do querySelectorAll
